...
import type { CatalogBook, Collection } from '../types';
import './collection-lane.css';

interface CollectionLaneProps {
...
export const CollectionLane: React.FC<CollectionLaneProps> = ({
  collection,
  books,
  onBookClick,
  onCollectionClick,
